...
export function ScrapeModal({
  ...
  return createPortal(
    <div className="fixed top-1/2 left-1/2 w-[500px] h-[80vh] -translate-1/2 p-4 pt-9 bg-gray-100 ring-2 ring-black/50 z-[999] rounded-xl flex flex-col items-center gap-4">
      <button
        onClick={close}
      ...
      <textarea
        defaultValue={text}
        className="w-full h-2/3 mb-2 resize-none focus:outline-none ring-1 ring-gray-400 focus:ring-1 focus:ring-blue-400 rounded-md p-2"
      />
